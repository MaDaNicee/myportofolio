    ...
    data: [
      {
        ...
        summary: "Pengalaman pencarian restoran yang cepat, dapat diinstal, dan tetap nyaman digunakan pada koneksi terbatas.",
        ...
        period: "2025",
        status: "Selesai",
        problem: "Pengguna membutuhkan katalog restoran yang cepat diakses pada perangkat mobile dan tetap berguna saat kualitas jaringan tidak stabil.",
        solution: "Menerapkan arsitektur PWA, caching aset, penyimpanan restoran favorit melalui IndexedDB, serta pengujian alur utama secara end-to-end.",
        outcome: "Menghasilkan aplikasi responsif yang dapat diinstal, memiliki dukungan offline, dan menawarkan pengalaman favorit yang persisten.",
        highlights: ["Progressive Web App dan offline caching", "Favorite restaurant dengan IndexedDB", "End-to-End Testing untuk alur utama"],
      ...
      },
      {
        ...
        summary: "Dashboard operasional untuk membantu UMKM mengelola katalog, gambar produk, dan stok dari satu tempat.",
        ...
        period: "2025",
        status: "Selesai",
        problem: "Pengelolaan produk dan stok yang tersebar membuat pembaruan data lambat dan rentan tidak sinkron.",
        solution: "Membangun dashboard terpusat dengan alur CRUD, upload gambar, validasi data, serta integrasi database melalui Prisma ORM.",
        outcome: "Proses pengelolaan katalog menjadi lebih terstruktur dan status stok dapat dipantau dari antarmuka yang sama.",
        highlights: ["CRUD produk terintegrasi database", "Upload dan pengelolaan gambar", "Monitoring stok melalui dashboard responsif"],
