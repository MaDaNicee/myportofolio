...
const resources: ResourceConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "summary", label: "Ringkasan Singkat", type: "textarea" },
      { name: "description", label: "Overview Project", type: "textarea", required: true },
      { name: "role", label: "Peran" },
      { name: "projectType", label: "Tipe Project" },
      { name: "period", label: "Periode" },
      { name: "status", label: "Status" },
      { name: "problem", label: "Masalah / Tantangan", type: "textarea" },
      { name: "solution", label: "Solusi", type: "textarea" },
      { name: "outcome", label: "Hasil / Dampak", type: "textarea" },
      { name: "highlights", label: "Fitur Utama (satu per baris)", type: "array" },
